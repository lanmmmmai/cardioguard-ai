...
inline constexpr const char* kTelemetryEndpoint = "https://192.168.1.10:8000/api/iot/telemetry";  // Endpoint nhận telemetry
inline constexpr const char* kDeviceToken = "REPLACE_DEVICE_TOKEN";       // Token xác thực thiết bị, cần thay thế
