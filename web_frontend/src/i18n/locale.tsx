...
const PAGE_META: Record<Locale, Record<string, { title: string; subtitle: string }>> = {
  ...
  en: {
    ...
    '/admin/delete-data': { title: 'Data Deletion Guide', subtitle: 'Instructions on how to request deleting account and personal data.' },
    '/doctor/delete-data': { title: 'Data Deletion Guide', subtitle: 'Instructions on how to request deleting account and personal data.' },
    '/patient/delete-data': { title: 'Data Deletion Guide', subtitle: 'Instructions on how to request deleting account and personal data.' },
